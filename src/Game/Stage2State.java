...
public class Stage2State extends State {
    ...
    public Stage2State() {
        ...
        this.elements.add(new Ballon(10, 800, -10));
        this.elements.add(new Ballon(100, 600, -10));
        this.elements.add(new BlueBallon(150, 900, -10));
        this.elements.add(new Ballon(300, 1000, -10));
        this.elements.add(new Ballon(400, 950, -10));
        this.elements.add(new BlueBallon(20, 1200, -10));
